...
output: 
  html_document:
    # Usa un tema semplice, poi lo sovrascriviamo con CSS
    theme: null
header-includes:
  - \usepackage{amsmath} # Questo è solo un esempio per un ambiente LaTeX
  # Codice CSS per forzare il font 'Times New Roman' o un generico 'serif'
  - \begin{document}\pagestyle{plain}\end{document}
  - \begin{document}\maketitle\end{document}
  - |
    <style>
      /* Font per il corpo del testo e titoli */
        body, h1, h2, h3, h4 {
